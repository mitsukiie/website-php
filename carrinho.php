...
?>
  ...
  carrinho.forEach(item => {
    ...
    card.dataset.id = item.id; // Adicionei novamente o dataset.id para manter consistência
    card.innerHTML = `
      <img src="${item.imagem}">
      ...
      <div class="card-btns">
        <button class="btn remover" onclick="removerItem('${item.nome}', '${item.tamanho}')">Remover do Carrinho</button>
